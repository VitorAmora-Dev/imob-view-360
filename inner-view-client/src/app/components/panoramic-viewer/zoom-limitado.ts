/** Ampliação máxima permitida no tour: 1,5×, isto é, cinquenta por cento. */
export const ZOOM_MAXIMO_DO_TOUR = 0.5;
 ...
 * a progressão contínua em vez de saltar direto para 50%.
 */
...
/**
 * Converte a roda para a faixa lógica 0..0,5.
...
/**
 * Mantém a pinça proporcional: afastar os dedos em 50% produz 1,5×.
